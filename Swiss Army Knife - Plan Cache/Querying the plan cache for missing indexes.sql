...
-- Will allow you to get a sense if the engine is outputting any information on what may be perceived as 
-- inadequacy between the current database design and possible benefits of creating new or changing current 
-- indexes for your relevant workload. 
-- It may be important to review this information against the current indexes, verify its validity against 
-- the importance of the workload it refers to, and always test before making any changes. 
